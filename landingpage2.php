...
<html lang="en">
  ...
  <body>
    ...
    <main class="main1" >
        ...
        <a href="signin.php" class="cta">Log Out</a>
        <div class="row">
       </main>
      ...
      <div class="content">
          <div class="boxthree">
            <div class="boxt">
              ...
              <button class="buton">Selengkapnya</button>
            </div>
            </div>
            <div class="boxt">
              ...
              <h3 class="textisi">Tanaman pangan lokal memiliki peran sentral dalam mendukung kesehatan manusia</h3>
              <button class="buton">Selengkapnya</button>
              </div>
            </div>
            <div class="boxt">
          ...
          <div class="fitur">
            <div class="fit">
              ...
              <div class="sidef">
                ...
                <a href="harga_pasar.php"><button>Akses fitur</button>
              </div>
            </div>
            <div class="fit">
              ...
              <div class="sidef">
                ...
                <a href="kalender.php"><button>Akses fitur</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer>
        ...
        <div class="fotbawah">Copy Right © 2023</div>
    </footer>
